...
<head>
    ...
    <style>
        ...
        .history { margin: 15px 0; padding: 10px; background: #f8f8f8; border-radius: 5px; font-family: monospace; font-size: 28px; font-weight: bold; letter-spacing: 2px; min-height: 30px; }
    </style>
</head>
<body>
<div class="container">
...
"""
    ...
    # 스트림릿 컴포넌트로 HTML 삽입
    components.html(chaos_game_html, height=900)
